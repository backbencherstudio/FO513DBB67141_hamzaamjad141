      ...
      child: ListView(
        children: [
          Align(
              ...
              child: CommonWidget.secondaryButton(child: Icon(Icons.arrow_back),onTap: ()=>context.pop(),)),
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                Text("Set Default Instructor",style: textTheme.titleMedium ,),
          ...
          SizedBox(height: 18.h,),
          PrimaryButton(bodyText: "Save Instructor", onTap: ()=>context.pop())
        ],
      ),
    ),
    ));
