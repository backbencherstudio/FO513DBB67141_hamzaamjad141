...
import 'package:aviation_app/features/pilot_log_book/presentation/widgets/log_book_summary/log_book_summary.dart';
    ...
    child: SingleChildScrollView(
      child: Column(
        children: [
          ...
          SizedBox(height: 30.h,),
          PrimaryButton(bodyText: "+ Add Flight Log", onTap: (){}),
          SizedBox(height: 15.h,),
          PrimaryButton(bodyText: "Set Default Instructor", onTap: (){},isSecondary: true,),
